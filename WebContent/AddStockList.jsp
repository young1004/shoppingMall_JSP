...
<body>
	<table align=center>
		...
		<tr>
			<th class="title" colspan=6>재고 보충 내역</th>
		</tr>
		...
		<tr>
			<form action="AddStockList.jsp" method="post">
				<%
	Date date = new Date();
...
%>
		...
		<tr>
			<th class="head">보충코드</th>
			<th class="head">관리자 ID</th>
			<th class="head">제품코드</th>
			<th class="head">제품명</th>
			<th class="head">추가개수</th>
			<th class="head">보충날짜</th>
		</tr>

		<%
	request.setCharacterEncoding("euc-kr");
	//String between_A = null, between_B = null;

	//DB.getConnection();
	ResultSet rs = DB.addStockList(between_A,between_B);
