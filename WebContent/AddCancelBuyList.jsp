...
<body>
	<table align=center>
		...
		<tr>
			<th class="title" colspan=6>주문 취소 내역</th>
		</tr>
		...
		<tr>
			<form action="AddCancelBuyList.jsp" method="post">
				<%
					Date date = new Date();
		...
		<tr>
			<th class="head">구매코드</th>
			<th class="head">고객 ID</th>
			<th class="head">제품코드</th>
			<th class="head">제품명</th>
			<th class="head">취소 날짜</th>
			<th class="head">취소 수량</th>
		</tr>
		...
		<%
			...
			//DB.getConnection();
			ResultSet rs = DB.addCancelBuyList(between_A, between_B);
