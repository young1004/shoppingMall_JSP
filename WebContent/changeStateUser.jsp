...
<body>
	...
	<table align=center width=70%>
		...
		<tr>
			<th class="title" colspan=7>구매 상품 현황</th>
		</tr>
		...
		<tr>
			<form action="changeStateUser.jsp" method="post">
				<%
					Date date = new Date();
		...
		<%
			...
			ResultSet rs = DB.selectBuyStateUser(id, between_A, between_B);
			...
			while (rs.next()) {
				...
				out.print("<form action='changeStateConfirmUser.jsp' method='post'>");
		...
		<th><input type="submit" class="button" value="구매확정"></th>
		</form>
		<%
			out.print("</tr>");
			}
